...
**Bear in mind that this package just gives you the clusters and clsuterheads.** The visualization for this was done using D3.js, the code for that isn't attached.
